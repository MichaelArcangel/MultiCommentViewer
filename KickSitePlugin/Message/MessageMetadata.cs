using KickSitePlugin;
using SitePlugin;
using System;
using System.Windows;
using System.Windows.Media;

namespace KickhSitePlugin
{
    internal class MessageMetadata : IMessageMetadata
    {
        private readonly IKickMessage _message;
        private readonly ICommentOptions _options;
        private readonly IKickSiteOptions _siteOptions;

        public Color BackColor
        {
            get
            {
                if (_message is IKickNotice)
                {
        ...
        public MessageMetadata(IKickMessage message, ICommentOptions options, IKickSiteOptions siteOptions, IUser user, ICommentProvider cp, bool isFirstComment)
        {
            _message = message;
            _options = options;
