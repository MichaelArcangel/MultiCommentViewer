...
namespace KickSitePlugin
{
    ...
    public class KickException : Exception
    {
        ...
        public KickException(string message, Exception inner) : base(message, inner) { }
        protected KickException(
          System.Runtime.Serialization.SerializationInfo info,
          System.Runtime.Serialization.StreamingContext context) : base(info, context) { }
    }

    [Serializable]
    public class NotLoggedInException : KickException
    {
    ...
    public class KickServer : ServerBase, IDataServer
    {
...
namespace KickSitePlugin.LowObject.ChannelInfo
{
...
namespace KickSitePlugin.LowObject.UserInfo
{
