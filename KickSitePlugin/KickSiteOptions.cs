...
{
    internal class KickSiteOptions : DynamicOptionsBase, IKickSiteOptions
    {
        /// <summary>
        /// @コテハンを自動登録するか
        /// </summary>
        ...
        internal KickSiteOptions Clone()
        {
            return (KickSiteOptions)this.MemberwiseClone();
        }
        internal void Set(KickSiteOptions changedOptions)
        {
